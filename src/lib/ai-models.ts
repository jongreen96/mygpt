...
export const models = {
  'gpt-4o': {
    ...
    inputCost: 2.5 * profit,
    outputCost: 10 * profit,
  },
  'gpt-4o-mini': {
    company: 'OpenAI',
    type: 'multimodal',
    ...
    inputCost: 0.15 * profit,
    outputCost: 0.6 * profit,
  },
  // o1: {
  //   company: 'OpenAI',
  //   type: 'multimodal',
  ...
  'gpt-3.5-turbo': {
    ...
    inputCost: 0.5 * profit,
    outputCost: 1.5 * profit,
  },
  'dall-e-2': {
    company: 'OpenAI',
    type: 'image',
